...
hero: xcode/hero.jpg
# devToId: 58033
summary: Tired of interrupted Xcode downloads? Resume them seamlessly with a quick trick
keywords: 'xcode, download, command line tools, homebrew, wget, cookies, direct link, uncompress'
---
...
- Search for the command line package you want to download (I'm going to use the latest stable Command Line tools for Xcode 10 and macOS Mojave).
  ![Command Line Tools download option](/media/blog/xcode/xcode-1.png)
...
- Select the Xcode version you want to download (I'm going to download Xcode 10).
  ![Xcode 10 download option](/media/blog/xcode/xcode-2.png)
